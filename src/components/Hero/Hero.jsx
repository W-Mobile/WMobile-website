...
const Hero = () => {
    ...
    <div className={styles.content}>
     ...
     <p className={styles.description}>We build mobile solutions that don't just digitize workflows—they create real value for your business and the people who use them every day.</p>
    </div>
